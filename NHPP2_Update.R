...
driver <- function(parameters, priors, data, iters){
  ...
  # out$g=matrix(NA, nrow = length(parameters$g), ncol = iters) # g REMOVED
  out$sigma_2=matrix(NA, nrow = 1, ncol = iters)
  # out$tau_2=matrix(NA, nrow = 1, ncol = iters) # g REMOVED
  # out$alpha=matrix(NA, nrow = 1, ncol = iters) # g REMOVED
...
# 
#     parameters <- update_tau_2(parameters, priors, data) # g REMOVED
